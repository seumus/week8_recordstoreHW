...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecordStore = __webpack_require__(3);
	...
	RecordStore.prototype = {
	  ...
	  listInventory: function(){
	    ...
	    for (i; i < this.records.length; i++) {
	      inventory.listing += this.records[i].title + " by " + this.records[i].artist + " price:$" + this.records[i].price + "\n";
	      inventory.totalPrice += this.records[i].price;
	    };
	    return inventory;
	    }
	}
